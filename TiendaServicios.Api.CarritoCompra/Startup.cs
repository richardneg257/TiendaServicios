...
namespace TiendaServicios.Api.CarritoCompra
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ContextoCarrito>(options => options.UseMySQL(Configuration.GetConnectionString("ConexionDatabase")));
            services.AddMediatR(typeof(Nuevo.Manejador).Assembly);
            services.AddHttpClient("Libros", config => { config.BaseAddress = new Uri(Configuration["Services:Libros"]); });
